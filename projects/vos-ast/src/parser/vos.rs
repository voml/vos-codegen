...
// Hash of the grammar file: DDAE9B6E2B257F7CD2596AFB8A990258AB71872BE39618965E82D294D999B5FB
...
mod peginator_generated {
    ...
    mod ListNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::ListNode { items: r });
            Ok(result)
        }
    }
    #[inline]
