...
// Hash of the grammar file: 88B5202A56C1A6202C6E3C48D510319B6F79CE3B5F7F10812C86F167631F180F
...
mod peginator_generated {
    ...
    mod KeyValueDot_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::KeyValueDot {
                key: r.key,
                value: r.value,
                position: state.range_until(new_state),
            });
    ...
    impl PegPosition for KeyValueDot {
        fn position(&self) -> &std::ops::Range<usize> {
            &self.position
        }
    }
