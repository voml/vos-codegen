...
// Hash of the grammar file: 2BB3968CE76285D52665F7B1641AED171083946E5580AD9C9DB664934D88509E
    ...
    mod TypeValueNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state.clone(), tracer, cache)?
                .map_with_state(|r, new_state| super::TypeValueNode { value: r, position: state.range_until(new_state) });
            Ok(result)
        }
    }
    #[inline]
